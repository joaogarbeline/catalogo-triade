...
export function AddToCartButton({ onAdd }: { onAdd: () => void }) {
  ...
  return (
    <button
      onClick={handleClick}
      className={`flex h-10 w-full items-center justify-center rounded-lg text-xs font-semibold text-white transition-all duration-250 ease-out active:scale-95 ${
